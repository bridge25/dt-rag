// @CODE:FRONTEND-INTEGRATION-001:HISTORY-PAGE
...
export default function AgentHistoryPage() {
  ...
  const { data: historyData, isLoading: isHistoryLoading } = useCoverageHistory(id!, {
    interval: 'daily',
  })
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          ...
          <p className="text-gray-600">
            Level {agent.level} • {agent.rarity} • {agent.current_xp} XP
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-50 rounded p-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{agent.total_queries}</p>
            </div>
            <div className="bg-gray-50 rounded p-4">
              <p className="text-sm text-gray-600 mb-1">Quality Score</p>
              <p className="text-2xl font-bold text-green-600">{agent.quality_score}</p>
            </div>
          </div>
        </div>
      </div>
