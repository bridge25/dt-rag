"""
Create additional golden dataset samples to reach 50+ total samples

Generates diverse query types covering common RAG use cases.
"""
...
def create_samples():
    """Create additional golden dataset samples"""
    ...
    samples = [
        {
            ...
            "source_doc_ids": ["doc_dtrag_overview"],
            "query_type": "simple",
            "taxonomy_path": ["Technology", "AI", "RAG Systems"],
            "metadata": {"generated_method": "manual", "topic": "system_overview"}
        },
        {
            ...
            "source_doc_ids": ["doc_hybrid_search"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Search", "Hybrid Search"],
            "metadata": {"generated_method": "manual", "topic": "hybrid_search"}
        },
        {
            ...
            "source_doc_ids": ["doc_ragas_metrics"],
            "query_type": "simple",
            "taxonomy_path": ["Technology", "Evaluation", "RAGAS"],
            "metadata": {"generated_method": "manual", "topic": "ragas_metrics"}
        },
        {
            ...
            "source_doc_ids": ["doc_ingestion_pipeline"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Data Processing", "Ingestion"],
            "metadata": {"generated_method": "manual", "topic": "ingestion"}
        },
        {
            ...
            "source_doc_ids": ["doc_security"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "Security", "Authentication"],
            "metadata": {"generated_method": "manual", "topic": "authentication"}
        },
        {
            ...
            "source_doc_ids": ["doc_classification"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "ML", "Classification"],
            "metadata": {"generated_method": "manual", "topic": "hitl_classification"}
        },
        {
            ...
            "source_doc_ids": ["doc_schema"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "Database", "Schema"],
            "metadata": {"generated_method": "manual", "topic": "database_schema"}
        },
        {
            ...
            "source_doc_ids": ["doc_costs"],
            "query_type": "simple",
            "taxonomy_path": ["Technology", "Costs", "LLM Pricing"],
            "metadata": {"generated_method": "manual", "topic": "costs"}
        },
        {
            ...
            "source_doc_ids": ["doc_orchestration"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Orchestration", "LangGraph"],
            "metadata": {"generated_method": "manual", "topic": "orchestration"}
        },
        {
            ...
            "source_doc_ids": ["doc_agent_factory"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "Agents", "Factory Pattern"],
            "metadata": {"generated_method": "manual", "topic": "agent_factory"}
        },
        {
            ...
            "source_doc_ids": ["doc_pii"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Security", "PII Detection"],
            "metadata": {"generated_method": "manual", "topic": "pii_detection"}
        },
        {
            ...
            "source_doc_ids": ["doc_monitoring"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "Observability", "Monitoring"],
            "metadata": {"generated_method": "manual", "topic": "monitoring"}
        },
        {
            ...
            "source_doc_ids": ["doc_taxonomy"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Taxonomy", "Version Management"],
            "metadata": {"generated_method": "manual", "topic": "taxonomy_versioning"}
        },
        {
            ...
            "source_doc_ids": ["doc_quality"],
            "query_type": "simple",
            "taxonomy_path": ["Technology", "Quality", "Thresholds"],
            "metadata": {"generated_method": "manual", "topic": "quality_thresholds"}
        },
        {
            ...
            "source_doc_ids": ["doc_batch_eval"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "Evaluation", "Batch Processing"],
            "metadata": {"generated_method": "manual", "topic": "batch_evaluation"}
        },
        {
            ...
            "source_doc_ids": ["doc_embeddings"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Embeddings", "Models"],
            "metadata": {"generated_method": "manual", "topic": "embedding_model"}
        },
        {
            ...
            "source_doc_ids": ["doc_bm25"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Search", "BM25"],
            "metadata": {"generated_method": "manual", "topic": "bm25_tokens"}
        },
        {
            ...
            "source_doc_ids": ["doc_versioning"],
            "query_type": "simple",
            "taxonomy_path": ["Technology", "API", "Versioning"],
            "metadata": {"generated_method": "manual", "topic": "api_versioning"}
        },
        {
            ...
            "source_doc_ids": ["doc_security_measures"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "Security", "Defense in Depth"],
            "metadata": {"generated_method": "manual", "topic": "security_measures"}
        },
        {
            ...
            "source_doc_ids": ["doc_concurrency"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Concurrency", "Job Processing"],
            "metadata": {"generated_method": "manual", "topic": "concurrency"}
        },
        {
            ...
            "source_doc_ids": ["doc_quality_issues"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "Quality", "Issue Handling"],
            "metadata": {"generated_method": "manual", "topic": "quality_issues"}
        },
        {
            ...
            "source_doc_ids": ["doc_reranking"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Reranking", "Cross-Encoder"],
            "metadata": {"generated_method": "manual", "topic": "cross_encoder"}
        },
        {
            ...
            "source_doc_ids": ["doc_query_types"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Evaluation", "Query Types"],
            "metadata": {"generated_method": "manual", "topic": "query_types"}
        },
        {
            ...
            "source_doc_ids": ["doc_consistency"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "Database", "Consistency"],
            "metadata": {"generated_method": "manual", "topic": "data_consistency"}
        },
        {
            ...
            "source_doc_ids": ["doc_migrations"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Database", "Migrations"],
            "metadata": {"generated_method": "manual", "topic": "migrations"}
        },
        {
            ...
            "source_doc_ids": ["doc_detailed_analysis"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "Evaluation", "Detailed Analysis"],
            "metadata": {"generated_method": "manual", "topic": "detailed_analysis"}
        },
        {
            ...
            "source_doc_ids": ["doc_error_handling"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Error Handling", "API Errors"],
            "metadata": {"generated_method": "manual", "topic": "error_handling"}
        },
        {
            ...
            "source_doc_ids": ["doc_api_best_practices"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "API", "Best Practices"],
            "metadata": {"generated_method": "manual", "topic": "api_best_practices"}
        },
        {
            ...
            "source_doc_ids": ["doc_ab_testing"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Experimentation", "A/B Testing"],
            "metadata": {"generated_method": "manual", "topic": "ab_testing"}
        },
        {
            ...
            "source_doc_ids": ["doc_router_comparison"],
            "query_type": "multi_context",
            "taxonomy_path": ["Technology", "API", "Router Architecture"],
            "metadata": {"generated_method": "manual", "topic": "router_comparison"}
        },
        {
            ...
            "source_doc_ids": ["doc_token_counting"],
            "query_type": "reasoning",
            "taxonomy_path": ["Technology", "Costs", "Token Counting"],
            "metadata": {"generated_method": "manual", "topic": "token_counting"}
        }
    ]
...
def main():
    """Main function"""
    additional_samples = create_samples()

    existing_file = max(Path("golden_datasets").glob("golden_dataset_*.json"))
    ...
    combined_samples = existing_samples + additional_samples
    print(f"Total samples: {len(combined_samples)}")

    output_file = Path("golden_datasets") / f"golden_dataset_combined_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    ...
    simple = sum(1 for s in combined_samples if s['query_type'] == 'simple')
    reasoning = sum(1 for s in combined_samples if s['query_type'] == 'reasoning')
    multi = sum(1 for s in combined_samples if s['query_type'] == 'multi_context')
    print(f"  - Simple: {simple} ({simple/len(combined_samples)*100:.1f}%)")
    print(f"  - Reasoning: {reasoning} ({reasoning/len(combined_samples)*100:.1f}%)")
    print(f"  - Multi-context: {multi} ({multi/len(combined_samples)*100:.1f}%)")
