...
CREATE TABLE IF NOT EXISTS documents (
    ...
    embedding vector(1536),  -- Using 1536 dimensions for OpenAI text-embedding-3-large
...
(
    ...
    'Vector embeddings are numerical representations of text that capture semantic meaning. In DT-RAG, we use 1536-dimensional embeddings generated from OpenAI text-embedding-3-large to enable semantic search capabilities.',
