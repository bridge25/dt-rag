...
@pytest.mark.asyncio
async def test_reflection_analyze_benchmark(async_client, sample_case_bank, sample_execution_logs):
    """
...
@pytest.mark.benchmark
@pytest.mark.asyncio
async def test_reflection_batch_benchmark(async_client, sample_case_bank, sample_execution_logs):
    """
