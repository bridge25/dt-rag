...
sys.path.append(os.path.join(os.path.dirname(__file__), '..', 'apps', 'orchestration', 'src'))
...
class TestCategoryFilter:
    ...
    def test_empty_allowed_paths(self):
        ...
        search_results = [
            {"chunk_id": "chunk_001", "taxonomy_path": ["AI", "RAG"]}
        ]
    ...
    def test_empty_document_path(self):
        ...
        search_results = [
            {"chunk_id": "chunk_001", "taxonomy_path": []}  # 빈 경로
        ]
...
class TestSecurityFilter:
    ...
    def test_filter_bypass_detection(self):
        ...
        assert SecurityFilter.detect_bypass_attempt(normal_query, normal_filters) is False
        
        # 필터 무력화 시도
        bypass_filters = {"canonical_in": False}
        assert SecurityFilter.detect_bypass_attempt(normal_query, bypass_filters) is True
