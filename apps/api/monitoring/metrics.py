...
class MetricsCollector:
    ...
    def record_latency(self, operation: str, latency_ms: float, labels: Dict[str, str] = None):
        """지연시간 기록"""
    ...
    def increment_counter(self, counter_name: str, labels: Dict[str, str] = None, value: int = 1):
        """카운터 증가"""
    ...
    def record_cache_operation(self, operation: str, result: str, labels: Dict[str, str] = None):
        """캐시 작업 기록"""
    ...
    def get_metrics_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_metrics_collected": sum(len(values) for values in self.metrics.values()),
