...
class TaxonomyNode(BaseModel):
    ...
    node_type: TaxonomyNodeType = Field(
        default=TaxonomyNodeType.LEAF, description="Node type"
    )
...
class TaxonomyVersion(BaseModel):
    ...
    is_active: bool = Field(
        default=False, description="Whether this is the active version"
    )
...
class TaxonomyStats(BaseModel):
    ...
    nodes_by_level: Dict[int, int] = Field(
        default_factory=dict, description="Count by level"
    )
