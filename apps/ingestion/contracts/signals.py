...
class DocumentUploadCommandV1(BaseModel):
    ...
    # @CODE:MYPY-CONSOLIDATION-002 | Phase 14c: call-overload (Fix 36 - min_items → min_length, max_items → max_length for Pydantic v2)
    ...
    @validator("file_name")
    def validate_file_extension(cls, v: str, values: Dict[str, Any]) -> str:
